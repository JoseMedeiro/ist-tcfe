...
\includegraphics[width=0.60\linewidth]{Circuit_envelope.pdf}
...
\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{Circuit_envelope_simple.pdf}
...
\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{PASSO41.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{Circuit_regulator.pdf}
...
\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{Circuit_regulator_simple.pdf}
...
\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{PASSO42.eps}
\caption{$V_{out}$.}
\label{fig:TEO_OUT}
\end{figure}

\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{PASSO5.eps}
\caption{$V_{out} - 12V$.}
\label{fig:TEO_OUT-12}
\end{figure}

\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{PASSO4.eps}
