...
\end{minipage}
  \caption{Variables in the Mesh Method. A variable preceded by @ is of type {\em current} and expressed in Ampere; variables preceded by * are expressed in Farad Ohm;other variables are of type {\em voltage} and expressed in Volt. (As shown in Tables \ref{tab:TEO_PASSO2} and \ref{tab:SIM_PASSO2})}
\end{table}
