...
In this section, the circuit shown in Figure~\ref{fig:Circuit_Base} is analyzed theoretically with the Nodal Method, Trasient solution in order to caracterize it in the interval $\left[-5,20\right[$.
...
\subsection{Step 2: Solution for $t=0$}
