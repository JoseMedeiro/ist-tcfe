...
\includegraphics[height=8cm]{Circuit3.pdf}
...
\begin{figure}[h] \centering
\includegraphics[height=8cm]{Circuit2.pdf}
...
\begin{figure}[h] \centering
\includegraphics[width=0.45\linewidth]{PASSO3.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.50\linewidth]{PASSO5.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{PASSO6-AMPLITUDE.eps}
\caption{Magnitude response of $V_s$, $v_6$, $V_c$ and $v_8$.}
\label{fig:TEO_MAG}
\end{figure}

\begin{figure}[h] \centering
\includegraphics[width=0.60\linewidth]{PASSO6-ANGULO.eps}
